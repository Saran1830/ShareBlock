        ...
        <div className="mt-10 grid gap-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
          ...
          <div className="bg-gray-200 overflow-hidden shadow rounded-lg hover:bg-gray-300 transition duration-300 cursor-pointer ease-in-out transform hover:-translate-y-1 hover:scale-105">
            ...
            <div className="p-6">
              ...
              <p className="mt-2 text-lg text-gray-600">
                ShareBlockleverages IPFS (InterPlanetary File System) to store files in a decentralized manner across multiple nodes. This eliminates reliance on a single centralized server, making the storage more secure and resilient to data loss.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-200 overflow-hidden shadow rounded-lg hover:bg-gray-300 transition duration-300 cursor-pointer ease-in-out transform hover:-translate-y-1 hover:scale-105">
            ...
            <div className="p-6">
              ...
              />
              <p className="mt-2 text-lg text-gray-600">
                ShareBlockutilizes content addressing to generate unique cryptographic hashes for each file stored on IPFS. These hashes act as permanent, immutable links that can be used to access and share files.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-200 overflow-hidden shadow rounded-lg hover:bg-gray-300 transition duration-300 cursor-pointer ease-in-out transform hover:-translate-y-1 hover:scale-105">
            ...
            <div className="p-6">
              ...
              />
              <p className="mt-2 text-lg text-gray-600">
                ShareBlockemploys advanced encryption techniques to secure the files during storage and transmission. This ensures that only authorized individuals can access the files, providing an added layer of security.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-200 overflow-hidden shadow rounded-lg hover:bg-gray-300 transition duration-300 cursor-pointer ease-in-out transform hover:-translate-y-1 hover:scale-105">
            ...
            <div className="p-6">
              ...
              />
              <p className="mt-2 text-lg text-gray-600">
                Fast and  ShareBlockleverages IPFS, a peer-to-peer file sharing protocol, which allows for faster and more efficient file sharing. Files are distributed across multiple nodes, enabling quicker downloads and reducing network congestion.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-200 overflow-hidden shadow rounded-lg hover:bg-gray-300 transition duration-300 cursor-pointer ease-in-out transform hover:-translate-y-1 hover:scale-105">
            ...
            <div className="p-6">
              ...
              />
              <p className="mt-2 text-lg text-gray-600">
                ShareBlock is designed to be compatible with multiple platforms and devices, including desktop computers, laptops, smartphones, and tablets. This enables users to access their files from anywhere, using their preferred device.
              </p>
            </div>
          </div>
        </div>
